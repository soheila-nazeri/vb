...
Partial Class frmAddConcreteItems
    ...
    Private Sub InitializeComponent()
        ...
        'Panel1
        '
        Me.Panel1.Controls.Add(Me.GrpPrice)
        ...
        'GrpPrice
        '
        Me.GrpPrice.Controls.Add(Me.txtDate)
        Me.GrpPrice.Controls.Add(Me.txtwidth)
        Me.GrpPrice.Controls.Add(Me.txtlength)
        Me.GrpPrice.Controls.Add(Me.txtSpecialWeight)
        Me.GrpPrice.Controls.Add(Me.txtWeight)
        Me.GrpPrice.Controls.Add(Me.txtAge)
        Me.GrpPrice.Controls.Add(Me.txtAvgCylinder)
        Me.GrpPrice.Controls.Add(Me.txtCylinder)
        Me.GrpPrice.Controls.Add(Me.txtCublic)
        Me.GrpPrice.Controls.Add(Me.txtLoadSurface)
        Me.GrpPrice.Controls.Add(Me.txtVolumecm3)
        Me.GrpPrice.Controls.Add(Me.txtCm2)
        Me.GrpPrice.Controls.Add(Me.txtHeight)
        Me.GrpPrice.Controls.Add(Me.Label14)
        Me.GrpPrice.Controls.Add(Me.Label13)
        Me.GrpPrice.Controls.Add(Me.Label12)
        Me.GrpPrice.Controls.Add(Me.Label11)
        Me.GrpPrice.Controls.Add(Me.Label10)
        Me.GrpPrice.Controls.Add(Me.Label9)
        Me.GrpPrice.Controls.Add(Me.Label8)
        Me.GrpPrice.Controls.Add(Me.Label7)
        Me.GrpPrice.Controls.Add(Me.Label6)
        Me.GrpPrice.Controls.Add(Me.Label5)
        Me.GrpPrice.Controls.Add(Me.Label4)
        ...
        Me.txtDate.Size = New System.Drawing.Size(134, 26)
    ...
    Friend WithEvents btnAddGood As Button
    Friend WithEvents GrpPrice As GroupBox
    Friend WithEvents txtwidth As Windows.Forms.TextBox
    Friend WithEvents txtlength As Windows.Forms.TextBox
    Friend WithEvents txtSpecialWeight As Windows.Forms.TextBox
    Friend WithEvents txtWeight As Windows.Forms.TextBox
    Friend WithEvents txtAge As Windows.Forms.TextBox
    Friend WithEvents txtAvgCylinder As Windows.Forms.TextBox
    Friend WithEvents txtCylinder As Windows.Forms.TextBox
    Friend WithEvents txtCublic As Windows.Forms.TextBox
    Friend WithEvents txtLoadSurface As Windows.Forms.TextBox
    Friend WithEvents txtVolumecm3 As Windows.Forms.TextBox
    Friend WithEvents txtCm2 As Windows.Forms.TextBox
